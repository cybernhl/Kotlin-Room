...
Java_com_newki_fdkaacutil_FDKAACUtil_init(JNIEnv *env, jobject instance, jint sampleRate,
...
Java_com_newki_fdkaacutil_FDKAACUtil_encode(JNIEnv *env, jobject instance, jshortArray input_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_newki_fdkaacutil_FDKAACUtil_release(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_newki_fdkaacutil_FDKAACUtil_initDecoder(JNIEnv *env, jobject instance) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_newki_fdkaacutil_FDKAACUtil_decode(JNIEnv *env, jobject instance, jbyteArray input_) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_newki_fdkaacutil_FDKAACUtil_releaseDecoder(JNIEnv *env, jobject instance) {
