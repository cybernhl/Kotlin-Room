...
class MagicBlackCatFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.blackcat)) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            ...
            for (j in 0..255) {
                arrayOfByte[1024 + j * 4] = arrayOfInt4[j].toByte()
