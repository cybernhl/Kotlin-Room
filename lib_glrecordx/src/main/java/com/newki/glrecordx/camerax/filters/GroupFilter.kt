...
class GroupFilter(mRes: Resources) : BaseFilter(mRes) {
    private val mFilterQueue: Queue<com.newki.glrecordx.camerax.filters.AFilter>
    private val mFilters: MutableList<com.newki.glrecordx.camerax.filters.AFilter> = mutableListOf()
    private var width = 0
    private var height = 0
    private var size = 0

    fun addFilter(filter: com.newki.glrecordx.camerax.filters.AFilter) {
        flip(filter.matrix, false, true)
        mFilterQueue.add(filter)
    }

    fun removeFilter(filter: com.newki.glrecordx.camerax.filters.AFilter): Boolean {
    ...
    fun removeFilter(index: Int): com.newki.glrecordx.camerax.filters.AFilter {
    ...
    private fun updateFilter() {
        var f: com.newki.glrecordx.camerax.filters.AFilter?
