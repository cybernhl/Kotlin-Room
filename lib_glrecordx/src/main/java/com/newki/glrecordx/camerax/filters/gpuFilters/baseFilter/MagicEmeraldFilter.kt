...
class MagicEmeraldFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.emerald)) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            ...
            for (j in 0..255) {
                ...
                arrayOfByte[1 + (1024 + j * 4)] = arrayOfInt4[j].toByte()
                arrayOfByte[2 + (1024 + j * 4)] = arrayOfInt6[j].toByte()
