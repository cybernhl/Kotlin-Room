...
class MagicValenciaFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.valencia)) {
    ...
    public override fun onInitialized() {
        ...
        runOnDraw {
            inputTextureHandles[0] = loadTexture(getApplicationContext(), "filter/valenciamap.png")
            inputTextureHandles[1] =
                loadTexture(getApplicationContext(), "filter/valenciagradientmap.png")
        }
    }
}