package com.newki.glrecordx.camerax
...
class GLCameraXView(context: Context, private val ratio: Float) : GLTextureView(context),
    GLTextureView.Renderer, Preview.SurfaceProvider, SurfaceTexture.OnFrameAvailableListener {
