...
class MagicSweetsFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.sweets)) {
    ...
    public override fun onInitialized() {
        ...
        runOnDraw {
            ...
            mMaskGrey1TextureId = loadTexture(getApplicationContext(), "filter/rise_mask2.jpg")
        }
    }
}