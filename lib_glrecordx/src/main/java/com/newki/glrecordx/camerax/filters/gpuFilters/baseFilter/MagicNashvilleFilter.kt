...
class MagicNashvilleFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.nashville)) {
    ...
    public override fun onInitialized() {
        ...
        runOnDraw {
            inputTextureHandles[0] = loadTexture(getApplicationContext(), "filter/nashvillemap.png")
        }
    }
}