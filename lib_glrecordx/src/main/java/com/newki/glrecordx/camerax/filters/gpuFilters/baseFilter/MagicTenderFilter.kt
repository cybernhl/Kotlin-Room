...
class MagicTenderFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.tender)) {
    ...
    public override fun onInitialized() {
        ...
        runOnDraw {
            ...
            mMaskGrey1TextureId =
                loadTexture(getApplicationContext(), "filter/bluevintage_mask1.jpg")
        }
    }
}