package com.newki.glrecordx.camerax.filters
...
import com.newki.glrecordx.camerax.utils.EasyGlUtils.genTexturesWithParameter
import android.opengl.GLES20

/**
 * draw并不执行父类的draw方法,所以矩阵对它无效
 */
class ProcessFilter(mRes: Resources?) : com.newki.glrecordx.camerax.filters.AFilter(mRes) {
    private val mFilter: com.newki.glrecordx.camerax.filters.AFilter
