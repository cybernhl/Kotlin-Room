...
class MagicWarmFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.warm)) {
    ...
    public override fun onInit() {
        ...
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(program, "layerImage")
        mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(program, "greyFrame")
    }
    ...
    public override fun onInitialized() {
        ...
        runOnDraw {
            ...
            mMaskGrey1TextureId = loadTexture(getApplicationContext(), "filter/warm_layer1.jpg")
            mMaskGrey2TextureId =
