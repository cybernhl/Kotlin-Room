...
class MagicPixarFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.pixar)) {
    ...
    public override fun onInitialized() {
        ...
        runOnDraw {
            inputTextureHandles[0] = loadTexture(getApplicationContext(), "filter/pixar_curves.png")
        }
    }
}