...
class MagicSunriseFilter :
    GPUImageFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.sunrise)) {
    private var mMaskGrey1TextureId = -1
    private var mMaskGrey1UniformLocation = 0
    private var mMaskGrey2TextureId = -1
    private var mMaskGrey2UniformLocation = 0
    private var mMaskGrey3TextureId = -1
    private var mMaskGrey3UniformLocation = 0
    ...
    override fun onDestroy() {
        ...
        GLES20.glDeleteTextures(1, intArrayOf(mMaskGrey1TextureId), 0)
        mMaskGrey1TextureId = -1
        GLES20.glDeleteTextures(1, intArrayOf(mMaskGrey2TextureId), 0)
        mMaskGrey2TextureId = -1
        GLES20.glDeleteTextures(1, intArrayOf(mMaskGrey3TextureId), 0)
    ...
    override fun onInit() {
        ...
        mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(program, "grey2Frame")
        mMaskGrey3UniformLocation = GLES20.glGetUniformLocation(program, "grey3Frame")
    }
    ...
    public override fun onInitialized() {
        ...
        runOnDraw {
            ...
            GLES20.glActiveTexture(GLES20.GL_TEXTURE4)
            mMaskGrey1TextureId = loadTexture(getApplicationContext(), "filter/amaro_mask1.jpg")
            GLES20.glActiveTexture(GLES20.GL_TEXTURE5)
            mMaskGrey2TextureId = loadTexture(getApplicationContext(), "filter/amaro_mask2.jpg")
            GLES20.glActiveTexture(GLES20.GL_TEXTURE6)
            mMaskGrey3TextureId = loadTexture(getApplicationContext(), "filter/toy_mask1.jpg")
        }
    }
}