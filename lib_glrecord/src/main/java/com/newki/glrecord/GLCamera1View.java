...
import com.newki.glrecord.camera1.CameraController;
import com.newki.glrecord.draw.CameraDrawer;
...
public class GLCamera1View extends GLSurfaceView implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public GLCamera1View(Context context) {
        this(context, null);
    }

    public GLCamera1View(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
