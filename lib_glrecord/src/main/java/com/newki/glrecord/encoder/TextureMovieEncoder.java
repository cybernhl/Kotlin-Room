package com.newki.glrecord.encoder;
...
import com.newki.glrecord.encoder.gles.EglCore;
import com.newki.glrecord.encoder.gles.WindowSurface;
...
import com.newki.glrecord.filters.gpuFilters.baseFilter.MagicCameraInputFilter;
...
public class TextureMovieEncoder implements Runnable {
    ...
    public static class EncoderConfig {
        ...
        public EncoderConfig(String path, int width, int height, int bitRate, EGLContext sharedEglContext) {
            this.path = path;
            mWidth = width;
            mHeight = height;
            mBitRate = bitRate;
