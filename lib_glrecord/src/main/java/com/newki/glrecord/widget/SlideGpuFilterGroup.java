package com.newki.glrecord.widget;
...
import com.newki.glrecord.model.MagicFilterFactory;
...
public class SlideGpuFilterGroup {
    ...
    public SlideGpuFilterGroup() {
        initFilter();
        scroller = new Scroller(GLCamera1Utils.getApplicationContext());
        DisplayMetrics mDisplayMetrics = GLCamera1Utils.getApplicationContext().getResources().getDisplayMetrics();
