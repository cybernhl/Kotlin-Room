...
import com.guadou.lib_baselib.ext.engine.image_select.ImageSelectGlideEngine.Companion.createGlideEngine
...
//        mPictureParameterStyle.pictureWeChatPreviewSelectedTextSize = 9;
    ...
    PictureSelector.create(this)
        ...
        .loadCacheResourcesCallback(GlideSelectCacheEngine.createCacheEngine()) // 获取图片资源缓存，主要是解决华为10部分机型在拷贝文件过多时会出现卡的问题，这里可以判断只在会出现一直转圈问题机型上使用
        ...
        .isSingleDirectReturn(selectNum == 1) // 单选模式下是否直接返回，PictureConfig.SINGLE模式下有效
