...
class WhorlLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mStrokeWidth = CommUtils.dip2px(DEFAULT_STROKE_WIDTH);
        mCenterRadius = CommUtils.dip2px(DEFAULT_CENTER_RADIUS);
