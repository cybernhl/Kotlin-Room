...
/**
 * EditText的输入金额格式化,限制N位数的小数点
 * java： mFeeMoneyEt.setFilters(new InputFilter[]{new ETMoneyValueFilter()});
 *
 * kt： et_input.filters = arrayOf(ETMoneyValueFilter().setDigits(3))
 */
